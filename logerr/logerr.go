...
// SegFastMsg --
func (e *Logerr) SegFastMsg(level, segment int, msg string) error {
...
// Fprintf --
// func (e *Logerr) Fprintf(f io.Writer, format string, v ...interface{}) (int, error) {
// 	return fmt.Fprintf(f, format, v...)
// }
