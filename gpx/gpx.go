...
// Previous version of nextTrkpt, which is 1.5 - 2 x slower. But checks also presens of
// closing tags </trkpt>.
func nextTrkpt2(gpxbytes []byte) (trkpSlice, gpxbytesTail []byte) {
	const opentagLen = 6
	const closetagLen = 8
	...
	l += opentagLen + 1 //skip opening tag
