...
func (r *Results) checkEnergySums(l *logerr.Logerr) {
	...
	if math.Abs(e1-e2) > 1e-5 {
		l.Msg(0, "Energy net sums difference > 1e-5\n",
				"Segment energy net sum" , e1, "\n",
				"Total energy net sum  " , e2, "\n")
	}
}
...
func (r *Results) calcRouteStats(o *Route) {
	...
	r.RelGradeSD = 100 * math.Sqrt(sumSD/float64(o.segments))
...
func (r *Results) addRouteStats(o *Route, p par) {
	...
	r.FilterRounds = o.filter.ipoBackStepRounds
	r.JriderTotal = o.jouleRider
	r.Time = o.time
	r.LatMean = o.LatMean
	r.Gravity = o.Gravity
	r.Filtered = o.eleUpGPX - o.eleUp
	r.Filterable = max(o.eleUpGPX, o.eleDownGPX) - (o.eleMax - o.eleMin)
