...
func (o *Route) RouteWriter(p par) (io.WriteCloser, error) {
...
func (r *Results) ResultWriter(p par, s string) (io.WriteCloser, error) {
...
func (r *Results) Display(p par, l *logerr.Logerr) {
	...
	// l.Printf("%s %5.2f\n", "Grade sign changes %", r.GradeSignChange)
